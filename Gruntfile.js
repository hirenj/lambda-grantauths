...
module.exports = function(grunt) {
  ...
  grunt.registerTask('deploy', function(func) {
    ...
    func = (func ? (':' + func) : '');
    grunt.task.run( ['env:prod','versioncheck','lambda_checkversion'+func,'force:lambda_package','force:lambda_package_targets' ].concat(tasks.map( (task) => 'force:'+task+func) ).concat(['rotateCertificates']));
  });
